...
class DBSspider(Spider):
    ...
    def parse_features(self, response):
        ...
        l.add_xpath('bedrooms', '//*[@id="product-detail-web"]/div[5]/div[2]/div/div[contains(span[1]/text(), "phòng ngủ")]/span[2]/text()')
        l.add_xpath('toilets', '//*[@id="product-detail-web"]/div[5]/div[2]/div/div[contains(span[1]/text(), "toilet")]/span[2]/text()')
        l.add_css('description', '.des-product::text')
        l.add_xpath('address', '//*[@id="product-detail-web"]/div[5]/div[2]/div/div[contains(span[1]/text(), "Địa chỉ")]/span[2]/text()')
        l.add_xpath('direction', '//*[@id="product-detail-web"]/div[5]/div[2]/div/div[contains(span[1]/text(), "Hướng nhà")]/span[2]/text()')
        l.add_xpath('balcony_direction', '//*[@id="product-detail-web"]/div[5]/div[2]/div/div[contains(span[1]/text(), "Hướng ban công")]/span[2]/text()')
        l.add_xpath('furniture', '//*[@id="product-detail-web"]/div[5]/div[2]/div/div[contains(span[1]/text(), "Nội thất")]/span[2]/text()')
        l.add_xpath('law_doc', '//*[@id="product-detail-web"]/div[5]/div[2]/div/div[contains(span[1]/text(), "Pháp lý")]/span[2]/text()')
